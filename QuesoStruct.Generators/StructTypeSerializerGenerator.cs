...
namespace QuesoStruct.Generators
{
    [Generator]
    public class StructTypeSerializerGenerator : ISourceGenerator
    {
        ...
        private string GenerateSerializerSource(ClassDeclarationSyntax classDef)
        {
            ...
            text.Append($"using QuesoStruct;");
            text.Append($"using QuesoStruct.Types.Pointers;");
            text.Append($"using QuesoStruct.Types.Primitives;");
            text.Append($"using QuesoStruct.Types.Collections;");
